...
angular
    ...
    .directive('headerPage', ['$window', '$location', '$rootScope', function ($window, $location, $rootScope) {
        return {
            templateUrl: 'views/common/layouts/header.html',
            controller: 'HeaderController',
        };
    }])
    .directive('footerPage', ['$window', '$location', '$rootScope', function ($window, $location, $rootScope) {
        return {
            templateUrl: 'views/common/layouts/footer.html',
            controller: 'footerController',
        };
    }])
    .directive('select2', ['$window', '$timeout', function ($window, $timeout) {
    ...
    .directive('dataTable', ['$window', '$timeout','$rootScope', function ($window, $timeout,$rootScope) {
    return function link(scope, element, attrs) {
        $timeout(function () {
            element.DataTable();
        });
